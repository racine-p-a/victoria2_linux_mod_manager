...
class InterfaceV2MM(object):
    ...
    def launch_game_with_selected_mod(self):
        ...
        destination_file_opener = open(os.path.expanduser("~") + '/.v2mm/mod_launcher', 'w')
        # 2° Copy the modified content.
        destination_file_opener.write(new_content)
        # Remember to make the file executable
        st = os.stat(os.path.expanduser("~") + '/.v2mm/mod_launcher')
        os.chmod(os.path.expanduser("~") + '/.v2mm/mod_launcher', st.st_mode | stat.S_IEXEC)
